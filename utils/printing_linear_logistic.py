...
def print_logistic_results(
    X_test,
    y_test,
    logistic_model,
    predictions_logistic_model,
    solver,
...
def main():
    ...
    logistic_model = ""  # a sklearn LogisticRegression
    predictions_logistic_model = ""  # your predictions from logistic_model
    solver = ""  # your solver, see sklearn docs

    print_logistic_results(
        X_test,
        y_test,
        logistic_model,
        predictions_logistic_model,

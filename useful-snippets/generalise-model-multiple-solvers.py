import show_model_permutations, print_results, show_partial_dep_plots
...
def logistic_regression(X_train, X_test, y_train, y_test):
    ...
    for solver in ['newton-cg', 'lbfgs', 'liblinear', 'sag', 'saga']:
        lin_model = fit_param_model(X_train, y_train,
                                        solver, C=0.8,
                                        max_iter=1000)
    ...
    show_partial_dep_plots(fit_param_model(X_train, y_train, solver='newton-cg'), X_test)
